...
SAVES_DIR = "./data/saves/complex_webqsp_cher"
...
DIC_PATH = data_dir+'share.complexwebqsp.question'
DIC_PATH_INT = data_dir+'share.complexwebqsp.question'
# DIC_PATH_INT = '../data/auto_QA_data/share_944K_INT.question'
TRAIN_QUESTION_ANSWER_PATH = data_dir+'Annotation_train.json'
TRAIN_QUESTION_ANSWER_PATH_INT = data_dir+'Annotation_train.json'
...
if __name__ == "__main__":
    ...
    sys.argv = ['train_scst_cher.py', '--cuda',
                '-l=./data/complexwebqsp/crossent_webqsp/pre_bleu_0.998_19.dat',
                '-n=rl_TR_1%_batch8_att=0_test', '-s=5', '-a=0', '--att=0', '--lstm=1', '--int',
                '-w2v=50', '--beam_width=10', '--CHER', '--MonteCarlo']
        ...
        for epoch in range(MAX_EPOCHS):
            ...
            for batch in data.iterate_batches(train_data, BATCH_SIZE):
                ...
                for idx, inp_idx in enumerate(input_batch):
                    ...
                    print(action_tokens)
                    argmax_reward = utils.calc_True_Reward_complexwebqsp_novar(action_tokens, qa_info, args.adaptive)
