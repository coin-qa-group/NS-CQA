...
# -*- coding: utf-8 -*-
"""
Created on 2020-05-14 12:28

@author: zhangyuhao
@File    : train_scst_true_reward_complexwebqsp.py
...
SAVES_DIR = "./data/saves/complex_webqsp_rl_514"
...
if __name__ == "__main__":
    ...
    sys.argv = ['train_scst_true_reward_webqsp.py', '--cuda', '-l=./data/complexwebqsp/crossent_webqsp/pre_bleu_0.999_19.dat', '-n=rl_att=1', '-s=5', '-a=0', '--att=1', '--lstm=1']
